...
* Request
  * Method: POST
  * URL: {{url}}/groups/:groupId/membership
  * Headers:
    * Content-Type: application/json
  * Body: none
...
* Request
  * Method: DELETE
  * URL: {{url}}/groups/:groupId/membership/:memberId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: GET
  * URL: {{url}}/events/:eventId/attendees
  * Body: none
...
* Request
  * Method: POST
  * URL: {{url}}/events/:eventId/attendance
  * Headers:
    * Content-Type: application/json
  * Body: none
...
* Request
  * Method: DELETE
  * URL: {{url}}/events/:eventId/attendance/:userId
  * Headers:
    * Content-Type: application/json
  * Body:
